  ...
  return (
    <div className="photo-grid">
      <div className="img-cont">
        <img className="photo-grid-item" src={urls[0]} alt=""/>
      </div>
      <div className="img-cont">
        <img className="photo-grid-item" src={urls[1]} alt=""/>
      </div>
      <div className="img-cont">
        <img className="photo-grid-item" src={urls[2]} alt=""/>
      </div>
      <div className="img-cont">
        <img className="photo-grid-item" src={urls[3]} alt=""/>
      </div>
      <div className="img-cont">
        <img className="photo-grid-item" src={urls[4]} alt=""/>
      </div>
    </div>
  )
}